...
func TestGetAllModules(t *testing.T) {
	...
	expectedModules := []string{"sqli", "xss", "cmdi", "csrf", "lfi", "openredirect", "ssrf", "ssti", "xxe", "jwt", "cors", "headers", "graphql", "websocket", "subdomain", "crlf", "race", "secrets", "sensitive", "dirlisting"}
